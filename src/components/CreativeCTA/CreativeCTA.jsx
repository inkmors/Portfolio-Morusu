...
export default function PortfolioLink() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-black/60 rounded-2xl overflow-hidden ">
        <div 
      ...
      <div className="relative py-16 md:py-20 lg:py-24 px-6 md:px-10 text-center">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="inline-flex items-center gap-3 px-8 py-4 bg-gray-900 text-white text-lg font-medium rounded-full border border-gray-800 transition-all"
        >
          Acessar Galeria
          <svg 
            width="20" 

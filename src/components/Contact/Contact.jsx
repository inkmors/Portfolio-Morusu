          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 shadow-lg">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <button 
                  type="submit"
                  className="w-full py-3 px-6 bg-[#fff] text-[#1D1D1D] font-bold rounded-lg hover:opacity-90 transition-opacity"
                >
                  Enviar Mensagem
                </button>
              </form>
            ...
            <div className="space-y-13">
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 shadow-lg">
                ...
                <div className="flex gap-4">
                  <a href="https://www.instagram.com/morusu.ink/" target="_blank" className="w-12 h-12 flex items-center justify-center bg-white/5 rounded-full hover:bg-[#fff]/20 transition-colors">
                  ...
                  <a href="https://www.linkedin.com/in/vin%C3%ADcius-lima-738603284/" target="_blank" className="w-12 h-12 flex items-center justify-center bg-white/5 rounded-full hover:bg-[#fff]/20 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                  ...
                  <a href="https://github.com/inkmors" target="_blank" className="w-12 h-12 flex items-center justify-center bg-white/5 rounded-full hover:bg-[#fff]/20 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">

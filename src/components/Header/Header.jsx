  ...
  return (
    <div className="flex items-center justify-center w-full mb-[6rem] sm:mb-[11rem] box-border">
      <nav className="relative flex w-full mx-4 md:mx-8 lg:mx-[5rem] max-w-[90%] md:max-w-[95rem] items-center flex-wrap justify-between p-4 font-[Mulish] text-[16px] md:text-[18px] h-[6rem]">
        ...
        <a href="#about" className="hidden sm:inline hover:text-[#6C6C6A] transition-colors">sobre</a>
        <span className="text-[10px] hidden sm:inline">•</span>
        <a href="#skills" className="hidden sm:inline hover:text-[#6C6C6A] transition-colors">skills</a>
        <span className="text-[10px] hidden sm:inline">•</span>

        <div className="flex flex-col items-center z-20">
          <span className="text-[20px] md:text-[24px] font-[1000] text-white">MORUSU</span>
          <span className="text-[10px] md:text-[12px] font-[JosefinSans] font-[600] text-center tracking-[2px] md:tracking-[4.4px] text-[#6C6C6A]">
            DEVELOPER
          </span>
        </div>
        <span className="text-[10px] hidden sm:inline">•</span>

        <a href="#projects" className="hidden sm:inline hover:text-[#6C6C6A] transition-colors">projetos</a>
        <span className="text-[10px] hidden sm:inline">•</span>
        <a href="#contact" className="hidden sm:inline hover:text-[#6C6C6A] transition-colors">contato</a>
        ...
        {isMenuOpen && (
          <div className="fixed inset-0 bg-[#0a0a0a] bg-opacity-95 z-10 flex flex-col items-center justify-center space-y-8">
            <a 
              href="#about" 
              className="text-2xl text-white hover:text-[#f4b315] transition-colors"
